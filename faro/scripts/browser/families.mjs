...
await p.evaluate(() => { localStorage.clear(); localStorage.setItem('faro.seenintro.v1', '1'); localStorage.setItem('faro.settings.v1', JSON.stringify({ botSpeed: 'normal', motion: 'reduced' })); });
