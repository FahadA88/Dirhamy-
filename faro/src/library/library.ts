...
const GAMES = 'faro.library.v1';
const REVIEWS = 'faro.reviews.v1';
const FAVS = 'faro.favourites.v1';
const PLAYS = 'faro.playhistory.v1';
const FOLLOWS = 'faro.follows.v1';
const BUILTIN_STATS = 'faro.builtinstats.v1';
