...
const BY_FAMILY: Record<Knobs['family'], (keyof Knobs)[]> = {
  ...
  trick: ['handSize', 'trump', 'mustFollowSuit', 'aceHigh', 'trickScoreBy', 'trickBidding',
    ...
    'handPassCount', 'jacksAreTrumps', 'soloDeclarer', 'turnedTrump', 'turnedTrumpFromStock',
    'stockDraw', 'lastTrickBonus', 'bagPenaltyPer', 'bagPenaltyPoints', 'hookDealer',
    'contractKittySize', 'contractKittyScores', 'handGrowsPerHand', 'handsCap',
    'meldMarriage', 'meldMarriagePoints'],
  climb: ['handSize', 'climbTwosHigh', 'climbCombos', 'climbBombSize', 'direction',
    'climbExchangeTop', 'climbExchangeSecond', 'handsCap'],
  ...
  rummy: ['handSize', 'rummySetMin', 'rummyRunMin', 'rummyKnock', 'rummyKnockAt', 'rummyLayOff',
    ...
    'perRankPoints'],
  war: ['warRoundCap', 'matchPlay', 'pointTarget', 'handsCap'],
  capture: ['captureTableStart', 'captureHandSize', 'captureSweepBonus', 'captureLastClaimerTakesRest'],
  bluff: ['bluffClaimRanks', 'matchPlay', 'pointTarget', 'handsCap'],
  ...
  pit: ['pitCornerSize', 'pitRoundCap', 'matchPlay', 'pointTarget', 'handsCap'],
  kent: ['kentHandSize', 'kentPoolSize', 'kentTellPlies', 'kentLetters', 'kentRoundCap',
    'matchPlay', 'pointTarget', 'handsCap'],
  ...
  solitaire: ['solColumns', 'solDeal', 'solFaceUp', 'solBuild', 'solMoveRun', 'solEmpty',
    ...
    'solDecks'],
  maid: ['maidOddRank', 'matchPlay', 'pointTarget', 'handsCap'],
  layout: ['layoutPiles', 'layoutCornerPiles', 'layoutCornerRank', 'layoutBuild', 'layoutMovePiles',
    'handSize', 'matchPlay', 'pointTarget', 'handsCap'],
  swap: ['swapSlots', 'swapPeekAtStart', 'swapPeekSelfRanks', 'swapPeekOtherRanks', 'swapBlindRanks',
    'swapCallName', 'swapTurnCap', 'swapCallPenalty', 'perRankPoints', 'matchPlay', 'pointTarget'],
};
...
export function authorSpec(): string {
  return `You are writing a card game for the Faro engine.
