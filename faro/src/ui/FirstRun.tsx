...
export function FirstRun() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('faro:show-intro', show);
    return () => window.removeEventListener('faro:show-intro', show);
  }, []);
...
export function resetFirstRun(): void {
  ...
  window.dispatchEvent(new Event('faro:show-intro'));
}
