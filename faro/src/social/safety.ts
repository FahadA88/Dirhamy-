...
const REPORTS = 'faro.reports.v1';
const BLOCKED = 'faro.blocked.v1';
const MUTED = 'faro.muted.v1';
...
const RESERVED = ['faro', 'decky', 'official', 'admin', 'moderator', 'staff', 'support'];
