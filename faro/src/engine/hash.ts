...
//
// Why not Web Crypto: subtle.digest is async and the engine is deliberately pure and
// synchronous — a shuffle can't await. Why not a library: the engine has zero runtime
// dependencies and this needs to run byte-identically on the server and in the browser,
// which is the whole basis of the fairness proof.
