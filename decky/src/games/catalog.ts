...
export const catalog: GameDefinition[] = [crazyEights, switchGame, spadesLite, hearts, euchre, president, goFish, rummy, ginRummy, war, tradeWinds, undertow, klondike, freecell, spider, bluff, slapjack, showdownPoker, pit];
